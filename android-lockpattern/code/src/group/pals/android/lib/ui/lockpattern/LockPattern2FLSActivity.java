 ...
 * @since v1.0
 */
public class LockPattern2FLSActivity extends Activity {

    private static final String CLASS_NAME = LockPattern2FLSActivity.class
            .getName();
	...
	private void init2FLSElements() {
		...
		mRecognizerIntent.putExtra(RecognizerIntent.EXTRA_SPEECH_INPUT_COMPLETE_SILENCE_LENGTH_MILLIS, Long.valueOf(1000));
    ...
    private final View.OnClickListener mBtnConfirmOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (mBtnOkCmd == ButtonOkCommand.CONTINUE) {
                ...
                if (mAutoSave)
                    SecurityPrefs.setPattern(LockPattern2FLSActivity.this, pattern);
